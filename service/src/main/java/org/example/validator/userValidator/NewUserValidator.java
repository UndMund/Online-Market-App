...
public class NewUserValidator implements Validator<UserDtoResponse> {
    ...
    @Override
    public ValidationResult isValid(UserDtoResponse object) throws ValidationException {
        var validationResult = new ValidationResult();
        if (!userDao.checkUnique(object.getUserName(), object.getEmail(), object.getPhoneNumber())) {
        ...
        if (Position.find(object.getPosition()).isEmpty()) {
